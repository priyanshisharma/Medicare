...
<section class="tabs content18 cid-smH7yzCdHX" id="tabs1-p">    
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12 col-md-9">
                <h3 class="mbr-section-title mb-0 mbr-fonts-style display-2"><strong style="font-family: 'Courgette', cursive;">AI Tools for Diagnosis</strong></h3>
            </div>
        </div>
                                ...
                                <div class="testbox">
                                  <form method="post">
                                    ...
                                    <div class="btn-block" style="text-align: center;">
                                      <button type="submit" class="btn btn-danger display-4" href="/" name="heart">Predict</button>
                                    </div>
                                  </form>
                                </div>
    ...
    //    'method' => 'POST',
    //    'contents' => json_encode($json2),
    //    'header' => "Content-Type: application/json\r\n" .
    //    "Accept: application/json\r\n",
       
    //  ));
    //  $context = stream_context_create($opts);
    //  $result = file_get_contents('https://heart-disease-techblitz.herokuapp.com/heart', false, $context);
    //  $response = json_decode($result);
    //  echo $response;
      //  $json2 =  file_get_contents('https://heart-disease-techblitz.herokuapp.com/heart', false, stream_context_create([
      //   'http' => [
      //       'method' => 'POST',
      //       'header'  => "Content-type: application/json",
