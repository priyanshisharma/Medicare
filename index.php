...
<html  >
  <head>
    ...
    <link rel="shortcut icon" href="assets/images/aarogya_small.png" type="image/x-icon">
            ...
            <div class="card col-12 col-md-6 col-lg-3">
                <div class="card-wrapper">
                    <div class="card-box align-center">
                        ...
                        <h5 class="card-title mbr-fonts-style display-7"><strong>Physical Care</strong></h5>
                        <p class="card-text mbr-fonts-style display-7">
                            We currently provide physical health diagnosis on the basis of any symptoms you face. A 
                            period tracker for our menstruating members. We've also curated "Body Space" to educate and 
                            assist you in your physical well being journey.
                        </p>
                    </div>
                </div>
            </div>
            <div class="card col-12 col-md-6 col-lg-3">
                <div class="card-wrapper">
                    <div class="card-box align-center">
                        ...
                        <h5 class="card-title mbr-fonts-style display-7"><strong>Mental Care</strong></h5>
                        <p class="card-text mbr-fonts-style display-7">
                            We currently provide solace by giving you a meditation tool & a chatbot buddy to talk to. We 
                            also provide mental health diagnosis through a simple questionnaire. Furthermore, We've curated 
                            "Mind Space" to educate and assist you in your mental well being journey.
                        </p>
                    </div>
                </div>
            </div>
